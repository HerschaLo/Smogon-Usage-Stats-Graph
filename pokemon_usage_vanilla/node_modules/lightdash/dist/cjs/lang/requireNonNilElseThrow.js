...
exports.requireNonNilElseThrow = void 0;
/**
 ...
 * // => throws TypeError
 */
const requireNonNilElseThrow = (value, errorSupplier) => {
    if (value == null) {
        throw errorSupplier();
    }
    return value;
};
exports.requireNonNilElseThrow = requireNonNilElseThrow;
//# sourceMappingURL=requireNonNilElseThrow.js.map