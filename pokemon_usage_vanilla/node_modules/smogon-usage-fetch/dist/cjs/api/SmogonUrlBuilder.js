...
exports.SmogonUrlBuilder = void 0;
const format_1 = require("../parsing/format");
const timeframe_1 = require("../parsing/timeframe");
/**
...
class SmogonUrlBuilder {
    ...
    build() {
        ...
        if (this.timeframe != null) {
            pathParts.push(timeframe_1.timeframeToString(this.timeframe));
        }
        ...
        if (this.format != null) {
            let fileName = format_1.formatToString(this.format);
...
exports.SmogonUrlBuilder = SmogonUrlBuilder;
