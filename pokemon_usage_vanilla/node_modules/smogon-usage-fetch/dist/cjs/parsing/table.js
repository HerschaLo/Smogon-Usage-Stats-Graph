...
exports.parseMarkdownTable = void 0;
...
const parseTableRow = (rowString, colsPerRow) => {
    const delimiterChar = "|";
    const rowWithoutLeadingOrTrailingDelimiter = lightdash_1.removeEnd(lightdash_1.removeStart(rowString.trim(), delimiterChar), delimiterChar);
 ...
 */
const parseMarkdownTable = (table, colsPerRow) => {
